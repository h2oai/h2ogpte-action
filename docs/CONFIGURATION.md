...
| `github_mcp_allowed_tools`    | No       | `get_label,issue_read,list_issues,search_issues,create_pull_request,list_pull_requests,pull_request_read,search_pull_requests,update_pull_request,update_pull_request_branch` | Comma-separated list                                                           | List of specific tools for GitHub MCP. See [tools](https://github.com/github/github-mcp-server/blob/main/README.md#tools).                   |
| `github_mcp_allowed_toolsets` | No       | `context,repos,issues,pull_requests,users`                                                                                                                                    | Comma-separated list                                                           | List of allowed toolsets for GitHub MCP. See [toolsets](https://github.com/github/github-mcp-server/blob/main/README.md#available-toolsets). |
