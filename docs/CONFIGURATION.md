...
| **Custom Collection (`collection_id`)**         | -            | String                                                                                                                       | Creates a new duplicate collection with the same settings and files as the specified collection. The original collection remains unchanged. New files from the PR/issue/comment will be added to the duplicated collection. If not specified, a new empty collection is created for each run. |
